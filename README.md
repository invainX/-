...
- 运行speed_distinguish.py实现题目碎片与已有碎片的一一对应，可得到对应的数字序列。同样需要修改路径
...
例如：初始序列为（1，2，3，5，4，0，7，8，9），此时无解，在第五步后强制交换第七位和第八位，则先设置目标序列为（1,2,3,4,5,0,8,7,9),第五步以后，再把目标序列设置为（1，2，3，4，5，0，7，8，9）
